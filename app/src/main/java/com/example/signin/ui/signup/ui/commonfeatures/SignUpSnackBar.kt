package com.example.signin.ui.signup.ui.commonfeatures
...
/**
 *  SignUpSnackBar class is responsible for displaying SnackBar messages
 ...
 */
class SignUpSnackBar : SignInSnackBar {
    ...
    override fun showSuccess(view: View, message: String) {
        try {
            ...
            e.printStackTrace()
            Log.d("SignUpSnackBar", "Error in showSuccess SnackBar: ${e.message.toString()}")
        }
    }
    ...
    override fun showError(view: View, message: String) {
        try {
            ...
            e.printStackTrace()
            Log.d("SignUpSnackBar", "Error in showError SnackBar: ${e.message.toString()}")
        }
    }
}